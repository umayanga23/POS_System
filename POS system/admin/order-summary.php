                        ...
                        <div id="myBillingArea">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="text-align: center;" colspan="2">
                                                            ...
                                                            <p style="font-size:16px; line-height:24px; margin:2px; padding:0;">#Addres</p>
                                                            <p style="font-size:16px; line-height:24px; margin:2px; padding:0;">Company xyz pvt limited</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <p style="font-size:14px; line-height:20px; margin:0px; padding:0;">Customer Phone Number : <?= $cRowData['phone'] ?></p>
                            ...
                            <?php
                                ...
                                if(isset($_SESSION['productItems'])){
                                    ...
                                    echo '<h class="text-center"> No Items Added</h5>';
                                }
                            ?>
                        </div>
