<?php
    ...
    if(isset($_POST['saveAdmin'])){
        ...
        if($name != '' && $email != '' && $password != ''){
            ...
            redirect('admins-create.php','pleace fill required field .');
        }
    }
    ...
    if(isset($_POST['UpdateAdmin'])){
        ...
        if($adminData ['status'] != 200){
            redirect('admin-edit.php?id='.$adminId, 'please fill required field.');
        }
        ...
        if($name != '' && $email != ''){
            ...
            if($result){
                redirect('admin-edit.php?id='.$adminId, 'admin update Successfully!');
            }
            else{
            ...
            redirect('admin-edit.php','pleace fill required field .');
        }
    }
    ...
    if(isset($_POST['saveProduct'])){
        ...
        if($_FILES['image']['size']>0){
            ...
            $finalImage = "assets/uploads/product/".$filename;
        }
        else{
            $finalImage = '';
        }
    ...
    if(isset($_POST['updateProduct'])){
        ...
        if($result){
            redirect('product-edit.php?='.$product_id, 'product update Successfully!');
        }
        else{
            redirect('product-edit.php?='.$product_id, 'something went wrong!');
        }
    }
    ...
    if(isset($_POST['UpdateCustomer'])){
        ...
        if($name != ''){
            ...
            if($emailCheck){
                if(mysqli_num_rows($emailCheck)> 0){
                    redirect('customers-edit.php?id='.$customerId, 'Email Already use');
            ...
            redirect('customers-edit.php?id='.$customerId,'Please fill required field');
        }
    }
?>